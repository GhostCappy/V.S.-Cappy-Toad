...
class Achievements {
	...
	{
		createAchievement('week1_nomiss',			{name: "Helping Out", description: "Beat Week Cappy on Hard with no Misses."});
		createAchievement('week2_nomiss',			{name: "We do a little trolling...", description: "Beat Week Cappy-M on Hard with no Misses."});
		createAchievement('ur_bad',					{name: "What a Funkin' Disaster!", description: "Complete a Song with a rating lower than 50%."});
