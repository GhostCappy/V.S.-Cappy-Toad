...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['V.S. Cappy Mod'],
			['CappyTJ5',			'cappy',		'Programmer, Composer, and Charter of Cappy Toad mod.',			'https://twitter.com/CappyTJ5',			'68048A'],
			['RedRetroThunder',		'retro',		'Artist and Animator of Cappy Toad mod.',							'https://twitter.com/RedRetroThunder',	'CF1751'],
			['Leetram',				'leetram',		'Charting for Capi [Hard]',			'https://youtube.com/channel/UCRabrvf2BHlq9XxdPVBy4YQ',	'FFC100'],
			[''],
			['Special Thanks'],
			['AriTheLuminary',		'ari',			'',													'https://twitter.com/AriTheLuminary',	'FDBDFF'],
			['Gio',					'gio',			'',													'https://twitter.com/FencyMaster',		'2DB9B1'],
			['Salad',				'salad',		'',													'https://twitter.com/SilthScape',		'995CBD'],
			['Tide',				'tide',			'',													'https://twitter.com/Sherwood361',		'B38AFF'],
			['JonTheUmbreon',		'jon',			'',													'https://twitter.com/JonUmbreon',		'0639C7'],
			['Lumii',				'pyr0',			'',													'https://twitter.com/Soroth13',			'285675'],
			['P-Slice Engine Team'],
